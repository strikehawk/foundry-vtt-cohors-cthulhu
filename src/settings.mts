...
export function registerSettings() {
  ...
  const gameInitialized = game;

  gameInitialized.settings.register("fallout", "skillsCompendium", {
  ...
  gameInitialized.settings.register("fallout", "partyAP", {
    name: "Party AP",
    scope: "world",
    config: false,
    default: 0,
  ...
  gameInitialized.settings.register("fallout", "gmAP", {
    name: "GM AP",
    scope: "world",
    config: false,
    default: 0,
  ...
  gameInitialized.settings.register("fallout", "maxAP", {
    name: "Max AP",
    scope: "world",
    config: false,
    default: 6,
  ...
  gameInitialized.settings.register("fallout", "hoversJsonLocation", {
    ...
    type: String,
    filePicker: true, // TODO Possible Foundry VTT types issue
    restricted: true, // TODO Possible Foundry VTT types issue
    onChange: foundry.utils.debouncedReload,
  } as any);
  gameInitialized.settings.register("fallout", "gmMomentumShowToPlayers", {
  ...
  gameInitialized.settings.register("fallout", "maxAppShowToPlayers", {
    name: "Players Can Setup Max AP",
    hint: "Allows players to setup the Party's MAX AP. Requires refresh on the players side.",
    scope: "world",
    config: true,
    default: false,
    type: Boolean,
  });
  gameInitialized.settings.register(
    "fallout",
    "automaticAmmunitionCalculation",
    {
  ...
  gameInitialized.settings.register("fallout", "carryBase", {
  ...
  gameInitialized.settings.register("fallout", "carryBaseRobot", {
